...
One universal convention (`ALONG-PROTOCOL v3.0.1`) and automation skills suite honored natively across **Claude Code**, **Google Antigravity**, **OpenAI Codex**, and **OpenCode**.
