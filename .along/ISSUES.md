...
- [x] `(bug)` [quality-gates-skip-hidden-directories](ISSUES/done/bug--quality-gates-skip-hidden-directories.md)
- [x] `(bug)` [migration-deletes-destination-without-backup](ISSUES/done/bug--migration-deletes-destination-without-backup.md)
- [x] `(bug)` [link-gates-skip-along-directory](ISSUES/done/bug--link-gates-skip-along-directory.md)
- [x] `(bug)` [kb-sync-rewrites-unrelated-numbered-links](ISSUES/done/bug--kb-sync-rewrites-unrelated-numbered-links.md)
...
- [x] `(bug)` [issue-create-stamps-wrong-agent-and-milestone](ISSUES/done/bug--issue-create-stamps-wrong-agent-and-milestone.md)
...
- [x] `(bug)` [generated-docs-emit-file-uri-links](ISSUES/done/bug--generated-docs-emit-file-uri-links.md)
